...
const SITE_GALLERY = {
  "zh-HK": [
    ...
    { alt: "颱風八號風球號外頭條，天文台台長發言", caption: "天文台台長親自公布颱風信號，八號或以上仲會彈出蘋果日報式「號外」頭條。" },
    { alt: "市政會議視窗，顯示十位官員及議員名單", caption: "全新立法會：十位有名有姓嘅官員議員，會按稅率、治安、環境等城市數據表達立場。" },
  ...
  "zh-TW": [
    ...
    { alt: "颱風八號風球號外頭條，天文台台長發言", caption: "天文台台長親自公布颱風信號，八號或以上還會彈出報紙式「號外」頭條。" },
    { alt: "市政會議視窗，顯示十位官員及議員名單", caption: "全新立法會：十位有名有姓的官員議員，會按稅率、治安、環境等城市數據表達立場。" },
  ...
  en: [
    ...
    { alt: "Typhoon Signal No. 8 breaking-news headline with the Observatory director speaking", caption: "The Observatory director personally announces typhoon signals, and Signal 8 or above triggers a tabloid-style breaking-news popup." },
    { alt: "Council chamber window listing ten officials and members", caption: "A full Legislative Council: ten named officials and members who take positions based on tax rate, public safety, environment and other city stats." },
  ...
  ja: [
    ...
    { alt: "台風シグナル8号の号外見出しと天文台長のコメント", caption: "天文台長自ら台風シグナルを発表。シグナル8号以上でタブロイド風の「号外」ポップアップが表示されます。" },
    { alt: "十人の議員・官僚を表示する議会ウィンドウ", caption: "本格的な立法会：実名の議員・官僚10人が、税率・治安・環境などの都市データに基づいて意見を表明します。" },
...
const SITE_GALLERY_SOURCES = [
  ...
  "assets/typhoonSystem.png",
  "assets/ourNewCouncilMembers.png",
