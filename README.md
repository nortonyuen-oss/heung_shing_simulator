# 香城模擬器 (The City of Heung Shing) v1.0.6

香城模擬器 (The City of Heung Shing) v1.0.6 is a SimCity 2000-style city builder with a local SQLite save system, isometric map view, and a classic windowed UI.
