# 香城模擬器 (The City of Heung Shing) v4.6.3 — 【萬家燈火】

香城模擬器 (The City of Heung Shing) v4.6.3 — 【萬家燈火】 is a SimCity 2000-style city builder with a local SQLite save system, isometric map view, cloud-assisted district news, and a classic windowed UI.
