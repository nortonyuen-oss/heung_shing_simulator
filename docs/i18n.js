...
const SITE_NEWS = {
  "zh-HK": {
    "title": "香城官方新聞",
    "metaTitle": "官方新聞 | 香城模擬器",
    "eyebrow": "OFFICIAL NEWS",
    "intro": "開發近況、城市大事同截圖，隨時更新。有意見想講，可以喺每篇新聞下面留言。",
    "loading": "正在讀取新聞…",
    "loaded": "展開回應可以睇晒同留低你自己嘅睇法。",
    "empty": "暫時未有新聞，密切留意。",
    "error": "暫時讀唔到新聞，請稍後重試。",
    "notConfigured": "新聞後台尚未接駁，暫時未能讀取。",
    "limited": "留言太密啦：每分鐘最多一則、每小時最多五則，請等一陣再試。",
    "invalid": "內容格式唔啱或者太長，請檢查後再試。",
    ...
    "sendError": "暫時貼唔到回應，請稍後重試。",
    "headline": "標題",
    "body": "內文",
    "noscript": "請啟用 JavaScript 以讀取新聞及留言。"
  },
  "zh-TW": {
    "title": "香城官方新聞",
    "metaTitle": "官方新聞 | 香城模擬器",
    "eyebrow": "OFFICIAL NEWS",
    "intro": "開發近況、城市大事與截圖，隨時更新。有意見想說，可以在每篇新聞下方留言。",
    "loading": "正在讀取新聞…",
    "loaded": "展開回應可以看到全部留言，也能留下你的看法。",
    "empty": "目前尚無新聞，請密切留意。",
    "error": "暫時無法讀取新聞，請稍後重試。",
    "notConfigured": "新聞後台尚未連接，暫時無法讀取。",
    "limited": "留言太頻繁了：每分鐘最多一則、每小時最多五則，請稍後再試。",
    "invalid": "內容格式不正確或太長，請檢查後再試。",
  ...
  "en": {
    "title": "Official News",
    "metaTitle": "Official News | The City of Heung Shing",
    "eyebrow": "OFFICIAL NEWS",
    "intro": "Development updates, city milestones and screenshots, posted as they happen. Leave a comment under any story to share what you think.",
    ...
    "notConfigured": "The news backend is not connected yet, so stories cannot be read right now.",
    "limited": "Too many comments in a short time: one per minute and five per hour. Please wait and try again.",
    "invalid": "The comment is malformed or too long. Please check it and try again.",
    ...
    "sendError": "Your reply could not be posted right now. Please try again later.",
    "headline": "Headline",
    "body": "Story",
    "noscript": "Enable JavaScript to read the news and its replies."
  },
  "ja": {
    "title": "香城公式ニュース",
    "metaTitle": "公式ニュース | 香城模擬器",
    "eyebrow": "OFFICIAL NEWS",
    "intro": "開発の近況、街の出来事、スクリーンショットを随時更新。各記事の下にコメントを残せます。",
    "loading": "ニュースを読み込み中…",
    "loaded": "返信を開くと全文とコメント欄が見られます。",
    "empty": "まだニュースはありません。しばらくお待ちください。",
    "error": "ニュースを読み込めませんでした。しばらくして再度お試しください。",
    "notConfigured": "ニュースの裏側がまだ接続されていないため、現在読み込めません。",
    "limited": "コメントの間隔が短すぎます：1分に1件、1時間に5件までです。しばらくしてから再度お試しください。",
    "invalid": "内容の形式が正しくないか長すぎます。確認してもう一度お試しください。",
    "unauthorized": "現在読み込めません。しばらくして再度お試しください。",
    "page": "ページ",
    "untitled": "無題のニュース",
    "readComments": "コメント",
    "comments": "件のコメント",
    "anonymous": "匿名の市民",
    "retry": "再試行",
    "moreComments": "コメントをさらに読み込む",
    "nickname": "ニックネーム（任意・登録不要）",
    "writeComment": "コメントを書く",
    "sending": "投稿中…",
    "sendComment": "コメントを投稿",
    "required": "コメント内容を入力してください。",
    "commentSent": "コメントを投稿しました。ご意見ありがとうございます！",
    "sendError": "現在コメントを投稿できません。しばらくして再度お試しください。",
    "headline": "見出し",
    "body": "本文",
    "noscript": "ニュースとコメントを読むには JavaScript を有効にしてください。"
  }
};
...
const SITE_ADS = {
  "zh-HK": {
    "title": "香城廣告街",
    "metaTitle": "香城廣告街 | 香城模擬器",
    "eyebrow": "ADVERTISEMENT STREET",
    ...
    "error": "暫時讀唔到廣告，請稍後重試。",
    "notConfigured": "廣告街後台尚未接駁，暫時未能讀取或提交。",
    "limited": "貼得太密啦：每分鐘最多一則、每小時最多五則，請等一陣再試。",
    "invalid": "內容格式唔啱或者太長，請檢查後再試。",
    "required": "請填寫廣告內容。",
    "sending": "正在貼上…",
    "sent": "廣告已經貼上，多謝支持香城廣告街！",
  ...
  "zh-TW": {
    ...
    "notConfigured": "廣告街後台尚未連接，暫時無法讀取或提交。",
    "limited": "投放太頻繁了：每分鐘最多一則、每小時最多五則，請稍後再試。",
    "invalid": "內容格式不正確或太長，請檢查後再試。",
    "required": "請填寫廣告內容。",
    "sending": "正在貼上…",
    "sent": "廣告已經貼上，謝謝支持香城廣告街！",
    "sendError": "暫時無法貼上廣告，請稍後重試。"
  },
  "en": {
    "title": "Heung Shing Advertisement Street",
    "metaTitle": "Advertisement Street | The City of Heung Shing",
    "eyebrow": "ADVERTISEMENT STREET",
    ...
    "send": "Post to Advertisement Street",
    ...
    "notConfigured": "The ad board backend is not connected yet, so ads cannot be read or posted.",
    ...
    "sending": "Posting…",
    "sent": "Your ad is posted. Thanks for supporting Advertisement Street!",
    "sendError": "Your ad could not be posted right now. Please try again later."
  },
  "ja": {
    "title": "香城広告通り",
    "metaTitle": "香城広告通り | 香城模擬器",
    "eyebrow": "ADVERTISEMENT STREET",
    ...
    "notConfigured": "広告通りの裏側がまだ接続されていないため、現在読み込みや投稿ができません。",
    "limited": "投稿の間隔が短すぎます：1分に1件、1時間に5件までです。しばらくしてから再度お試しください。",
    "invalid": "内容の形式が正しくないか長すぎます。確認してもう一度お試しください。",
    "required": "広告内容を入力してください。",
    "sending": "投稿中…",
    "sent": "広告を投稿しました。香城広告通りへのご協力ありがとうございます！",
...
const SITE_MODERATE = {
  ...
  "en": {
    ...
    "queueAds": "Pending: Advertisement Street",
    "loading": "Loading…",
