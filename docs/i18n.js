...
const SITE_FEEDBACK = {
  "zh-HK": {
    ...
    "newPost": "寫低你嘅問題或意見",
    "publicNote": "留言同回覆會公開顯示。發表時需要 GitHub 帳號，最後一步會到 GitHub 確認提交。",
    "type": "留言類別",
    "bug": "問題回報",
    "question": "玩法疑問",
    "suggestion": "功能建議",
    ...
    "other": "其他／不適用",
    "details": "內容",
    "detailsHelp": "回報問題時，請寫低發生咗乜事、重現步驟同預期結果。截圖可以到 GitHub 提交時加入。",
    "prepare": "整理留言",
    "required": "請填寫標題同內容。",
    "preview": "檢查留言，再到 GitHub 發表",
    "handoff": "留言已整理好，但尚未發表。下一步會開啟 GitHub，登入並檢查內容後按提交。",
    "longPost": "內容較長，請先複製以下全文，再到 GitHub 貼入內容欄提交；呢度會保留你填寫嘅資料。",
    "publish": "到 GitHub 確認發表 ↗",
    "openAndPaste": "開啟 GitHub 並貼上全文 ↗",
    "copy": "複製留言全文",
    "copied": "已複製留言全文。",
    "copyManually": "請在已選取嘅文字按複製。",
    "listTitle": "大家嘅留言",
    "filter": "處理狀態",
    "all": "全部",
    "open": "處理中",
    ...
    "refresh": "重新整理",
    "loading": "正在讀取留言…",
    "loaded": "按標題可到 GitHub 查看；展開可讀取內容同回覆。",
    "empty": "暫時未有符合篩選嘅留言。歡迎寫低第一個問題或意見。",
    "error": "暫時讀唔到留言，請稍後重試，或直接到 GitHub 查看。",
    "limited": "GitHub 暫時限制讀取次數，請稍後重試，或直接到 GitHub 查看。",
    "page": "頁",
    "previous": "上一頁",
    "next": "下一頁",
    "readThread": "內容與回覆",
    ...
    "untitled": "未命名留言",
    "noBody": "未填寫內容。",
    "allOnGitHub": "在 GitHub 查看所有留言 ↗",
    "noJs": "未啟用 JavaScript 仍可直接到 GitHub 查看及發表留言。",
    "afterPost": "在 GitHub 完成提交或回覆後，返嚟按「重新整理」就可以讀取最新紀錄。",
    "privacy": "請保持尊重，唔好公開 API key、密碼、個人資料或未遮蔽嘅私人存檔。留言儲存在 GitHub，帳號同內容亦受 GitHub 條款及私隱政策規管。",
    "draftLabel": "留言全文"
  },
  "zh-TW": {
    "title": "玩家留言板",
    ...
    "newPost": "寫下你的問題或意見",
    "publicNote": "留言與回覆會公開顯示。發表時需要 GitHub 帳號，最後一步會到 GitHub 確認提交。",
    "type": "留言類別",
    "bug": "問題回報",
    "question": "玩法疑問",
    "suggestion": "功能建議",
    ...
    "other": "其他／不適用",
    "details": "內容",
    "detailsHelp": "回報問題時，請寫下發生的情況、重現步驟與預期結果。截圖可以到 GitHub 提交時加入。",
    "prepare": "整理留言",
    "required": "請填寫標題與內容。",
    "preview": "檢查留言，再到 GitHub 發表",
    "handoff": "留言已整理好，但尚未發表。下一步會開啟 GitHub，登入並檢查內容後按提交。",
    "longPost": "內容較長，請先複製以下全文，再到 GitHub 貼入內容欄提交；這裡會保留你填寫的資料。",
    "publish": "到 GitHub 確認發表 ↗",
    "openAndPaste": "開啟 GitHub 並貼上全文 ↗",
    "copy": "複製留言全文",
    "copied": "已複製留言全文。",
    "copyManually": "請在已選取的文字按複製。",
    "listTitle": "大家的留言",
    "filter": "處理狀態",
    "all": "全部",
    "open": "處理中",
    ...
    "refresh": "重新整理",
    "loading": "正在讀取留言…",
    "loaded": "點擊標題可到 GitHub 查看；展開可讀取內容與回覆。",
    "empty": "目前沒有符合篩選的留言。歡迎寫下第一個問題或意見。",
    "error": "暫時無法讀取留言，請稍後重試，或直接到 GitHub 查看。",
    "limited": "GitHub 暫時限制讀取次數，請稍後重試，或直接到 GitHub 查看。",
    "page": "頁",
    "previous": "上一頁",
    "next": "下一頁",
    ...
    "allOnGitHub": "在 GitHub 查看所有留言 ↗",
    "noJs": "未啟用 JavaScript 仍可直接到 GitHub 查看及發表留言。",
    "afterPost": "在 GitHub 完成提交或回覆後，回來按「重新整理」即可讀取最新紀錄。",
    "privacy": "請保持尊重，不要公開 API key、密碼、個人資料或未遮蔽的私人存檔。留言儲存在 GitHub，帳號與內容也受 GitHub 條款及隱私政策規範。",
    "draftLabel": "留言全文"
  },
  "en": {
    ...
    "publicNote": "Posts and replies are public. A GitHub account is required to publish; you will confirm the final submission on GitHub.",
    "type": "Type",
    "bug": "Bug report",
    ...
    "details": "Message",
    "detailsHelp": "For a bug, describe what happened, how to reproduce it and what you expected. Add screenshots on GitHub before submitting.",
    "prepare": "Prepare message",
    "required": "Please enter a title and message.",
    "preview": "Review your message, then publish on GitHub",
    "handoff": "Your message is prepared but has not been published. Continue to GitHub, sign in, review it and submit.",
    "longPost": "This message is long. Copy the full text below, then paste it into the message field on GitHub before submitting. Your form stays here.",
    "publish": "Review & publish on GitHub ↗",
    "openAndPaste": "Open GitHub & paste the full text ↗",
    "copy": "Copy full message",
    "copied": "Message copied.",
    "copyManually": "Copy the selected text manually.",
    ...
    "loaded": "Open a title on GitHub, or expand a post to read its message and replies.",
    "empty": "No messages match this filter yet. Be the first to share a question or comment.",
    "error": "Messages could not be loaded. Try again later or view them directly on GitHub.",
    "limited": "GitHub is temporarily limiting requests. Try again later or view messages directly on GitHub.",
    "page": "Page",
    "previous": "Previous",
    "next": "Next",
    "readThread": "Message & replies",
    "replies": "replies",
    "reply": "Reply on GitHub ↗",
    "moreReplies": "Load more replies",
    "retry": "Retry",
    "unknownAuthor": "Deleted account",
    "untitled": "Untitled message",
    "noBody": "No message body.",
    "allOnGitHub": "View all messages on GitHub ↗",
    "noJs": "With JavaScript disabled, you can still read and post directly on GitHub.",
    "afterPost": "After submitting or replying on GitHub, return here and select Refresh to load the latest messages.",
    "privacy": "Be respectful. Do not publish API keys, passwords, personal information or unredacted private saves. Messages are stored on GitHub; its terms and privacy policy apply to accounts and content.",
    "draftLabel": "Full message"
  },
  "ja": {
    "title": "プレイヤー掲示板",
    ...
    "newPost": "質問・コメントを書く",
    "publicNote": "投稿と返信は公開されます。投稿にはGitHubアカウントが必要で、最後にGitHub上で内容を確認して送信します。",
    "type": "種類",
    "bug": "不具合報告",
    "question": "遊び方の質問",
    "suggestion": "機能の提案",
    ...
    "other": "その他／該当なし",
    "details": "内容",
    "detailsHelp": "不具合の場合は、起きたこと、再現手順、期待した結果をご記入ください。スクリーンショットはGitHubで送信前に追加できます。",
    "prepare": "投稿内容を準備",
    "required": "タイトルと内容をご記入ください。",
    "preview": "内容を確認してGitHubで投稿",
    "handoff": "内容を準備しましたが、まだ投稿されていません。GitHubに進み、ログインして内容を確認のうえ送信してください。",
    "longPost": "長い投稿です。以下の全文をコピーし、GitHubの本文欄に貼り付けて送信してください。このフォームの入力内容は残ります。",
    "publish": "GitHubで確認して投稿 ↗",
    "openAndPaste": "GitHubを開いて全文を貼り付け ↗",
    "copy": "全文をコピー",
    "copied": "コピーしました。",
    "copyManually": "選択されたテキストを手動でコピーしてください。",
    "listTitle": "みなさんの投稿",
    "filter": "状態",
    "all": "すべて",
    "open": "対応中",
    ...
    "refresh": "更新",
    "loading": "投稿を読み込み中…",
    "loaded": "タイトルからGitHubを開くか、投稿を展開して本文と返信を読めます。",
    "empty": "この条件に一致する投稿はまだありません。最初の質問やコメントをお寄せください。",
    "error": "投稿を読み込めませんでした。後でもう一度試すか、GitHubで直接ご確認ください。",
    "limited": "GitHubのリクエスト制限中です。後でもう一度試すか、GitHubで直接ご確認ください。",
    "page": "ページ",
    "previous": "前へ",
    "next": "次へ",
    "readThread": "本文と返信",
    ...
    "retry": "再試行",
    "unknownAuthor": "削除されたアカウント",
    "untitled": "無題の投稿",
    "noBody": "本文はありません。",
    "allOnGitHub": "GitHubですべての投稿を見る ↗",
    "noJs": "JavaScriptが無効でも、GitHubで直接閲覧・投稿できます。",
    "afterPost": "GitHubで投稿・返信した後、このページに戻って「更新」を押すと最新の記録を読み込めます。",
    "privacy": "互いを尊重し、APIキー、パスワード、個人情報、未編集の私的なセーブデータを公開しないでください。投稿はGitHubに保存され、アカウントと内容にはGitHubの規約とプライバシーポリシーが適用されます。",
    "draftLabel": "投稿全文"
  }
};
...
function applyMetaTags() {
  ...
  const pageText = ["copyright", "feedback"].includes(pageKey) ? text[pageKey] : null;
  const meta = pageText
