...
For Windows auto-update, the GitHub Release must include the original NSIS setup file, `latest.yml`, and the matching setup `.blockmap` generated by electron-builder.
