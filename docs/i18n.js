...
const SITE_NEWS = {
  "zh-HK": {
    ...
    "forumNote": "你嘅留言經版主批准之後，會喺遊戲入面嘅【香城討論區】出現。",
    "loading": "正在讀取新聞…",
  ...
  "zh-TW": {
    ...
    "forumNote": "你的留言經版主核准後，會出現在遊戲中的【香城討論區】。",
    "loading": "正在讀取新聞…",
  ...
  "en": {
    ...
    "forumNote": "Once the moderator approves your comment, it'll appear in the game's Heung Shing Forum.",
  ...
  "ja": {
    ...
    "forumNote": "モデレーターが承認したコメントは、ゲーム内の【香城討論区】に表示されます。",
    "loading": "ニュースを読み込み中…",
