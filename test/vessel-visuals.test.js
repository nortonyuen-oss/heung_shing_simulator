...
// dock point must sit strictly between the harbor's own land edge (fraction
// 0, which would render the ship on top of land) and the direct water tile
// used for routing (fraction 1, the pre-redesign spawn point), never AT or
// past either boundary, and it must respond to a beach-buffer offset (>1)
