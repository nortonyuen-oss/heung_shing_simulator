...
const SITE_GALLERY = {
  "zh-HK": [
    ...
    { title: "華燈初上", alt: "傍晚七點幾嘅住宅區，街燈已亮，窗燈逐棟填滿，天上有星", caption: "日落後街燈一齊亮起，然後窗燈逐棟填滿；住宅、商業、工業各有自己嘅開燈比例，醫院警局通宵全開。" },
  ...
  "zh-TW": [
    ...
    { title: "華燈初上", alt: "傍晚七點多的住宅區，路燈已亮，窗燈逐棟填滿，天上有星", caption: "日落後路燈一起亮起，然後窗燈逐棟填滿；住宅、商業、工業各有自己的開燈比例，醫院警局整夜全開。" },
  ...
  en: [
    ...
    { title: "Lights coming on", alt: "A residential district just after seven in the evening: street lamps on, windows filling in one building at a time, stars overhead", caption: "After sunset the street lamps come on together, then the windows fill in building by building; homes, offices and industry each keep their own share lit, and hospitals and police stations stay lit all night." },
  ...
  ja: [
    ...
    { title: "灯りがともる頃", alt: "夜7時過ぎの住宅地。街灯はすでに点き、窓の灯りが一棟ずつ増え、空には星", caption: "日没後、街灯はいっせいに点き、窓の灯りは一棟ずつ増えていきます。住宅・商業・工業はそれぞれ点灯する割合が違い、病院と警察は一晩中点いたまま。" },
