...
const SITE_FEEDBACK = {
  "zh-HK": {
    ...
    "newPost": "寫低你嘅問題或意見",
    "publicNote": "登記做街坊先可以留言。留言同回覆會公開顯示，用返你嘅街坊名。",
    "loginRequired": "登記做街坊先可以留言。",
    "guestBadge": "訪客",
    ...
    "untitled": "未命名留言",
    "noBody": "未填寫內容。",
    "afterPost": "登記做街坊先可以留言、回覆。按「重新整理」睇最新留言。",
  ...
  "zh-TW": {
    ...
    "newPost": "寫下你的問題或意見",
    "publicNote": "登記做街坊先可以留言。留言與回覆會公開顯示，使用你的街坊名。",
    "loginRequired": "登記做街坊先可以留言。",
    "guestBadge": "訪客",
    "unauthorized": "登入已經過期，請重新登入。",
    "nickname": "暱稱（選填，不必註冊）",
    ...
    "untitled": "未命名留言",
    "noBody": "未填寫內容。",
    "afterPost": "登記做街坊先可以留言、回覆。按「重新整理」查看最新留言。",
  ...
  "en": {
    ...
    "publicNote": "Register as a neighbour to post. Posts and replies are public and show your neighbour name.",
    "loginRequired": "Register as a neighbour to post.",
    "guestBadge": "Guest",
    ...
    "afterPost": "Register as a neighbour to post or reply. Select Refresh to load the latest messages.",
  ...
  "ja": {
    ...
    "newPost": "質問・コメントを書く",
    "publicNote": "街坊会員に登録すると投稿できます。投稿と返信は公開され、あなたの街坊名で表示されます。",
    "loginRequired": "街坊会員に登録すると投稿できます。",
    "guestBadge": "ゲスト",
    ...
    "untitled": "無題の投稿",
    "noBody": "本文はありません。",
    "afterPost": "街坊会員に登録すると投稿・返信できます。「更新」で最新の投稿を読み込めます。",
...
const SITE_NEWS = {
  "zh-HK": {
    ...
    "loginRequired": "登記做街坊先可以開帖、留言、俾 emoji 回應。",
    "guestBadge": "訪客",
    "official": "官方",
    "categoryAll": "全部",
    "categoryCity": "城市發展",
  ...
  "zh-TW": {
    ...
    "loginRequired": "登記做街坊先可以開帖、留言、給 emoji 回應。",
    "guestBadge": "訪客",
    "official": "官方",
    "categoryAll": "全部",
    "categoryCity": "城市發展",
  ...
  "en": {
    ...
    "loginRequired": "Register as a neighbour to post, comment or react.",
    "guestBadge": "Guest",
    "official": "Official",
    "categoryAll": "All",
  ...
  "ja": {
    ...
    "loginRequired": "街坊会員に登録すると、投稿・コメント・リアクションができます。",
    "guestBadge": "ゲスト",
    "official": "公式",
    "categoryAll": "すべて",
    "categoryCity": "都市開発",
...
const SITE_ADS = {
  "zh-HK": {
    ...
    "newAd": "落一則廣告",
    "publicNote": "登記做街坊先可以落廣告。廣告會即刻喺呢頁見到；批准後先會喺遊戲入面播放。",
    "loginRequired": "登記做街坊先可以落廣告。",
    "unauthorized": "登入已經過期，請重新登入。",
    "text": "廣告內容（一句就夠）",
  ...
  "zh-TW": {
    ...
    "newAd": "投一則廣告",
    "publicNote": "登記做街坊先可以投廣告。廣告會立即在此頁顯示；核准後才會在遊戲中播放。",
    "loginRequired": "登記做街坊先可以投廣告。",
    "unauthorized": "登入已經過期，請重新登入。",
    "text": "廣告內容（一句就夠）",
  ...
  "en": {
    ...
    "newAd": "Submit an ad",
    "publicNote": "Register as a neighbour to submit an ad. Your ad shows on this page right away; it only reaches the game once approved.",
    "loginRequired": "Register as a neighbour to submit an ad.",
    "unauthorized": "Your session has expired — please sign in again.",
  ...
  "ja": {
    ...
    "newAd": "広告を投稿する",
    "publicNote": "街坊会員に登録すると広告を投稿できます。広告はこのページにすぐ表示されます。ゲームに反映されるのは承認後です。",
    "loginRequired": "街坊会員に登録すると広告を投稿できます。",
    "unauthorized": "セッションの有効期限が切れました。もう一度ログインしてください。",
    "text": "広告文（一言でOK）",
...
const SITE_MEMBER = {
  "zh-HK": {
    ...
    "intro": "登記做街坊，先可以喺【香城討論區】發帖、留言、俾 emoji 回應，同喺【香城連儂牆】留言——登記俾你一個固定嘅街坊身份，日後福利會再加福利都係喺呢個身份上面加。",
    "joinTitle": "登記 / 登入",
    "registerTab": "登記",
    "loginTab": "登入",
    ...
    "avatarUpload": "上傳頭像",
    "avatarUploading": "正在上傳…",
    "avatarUploaded": "頭像已經更新。",
    "avatarInvalidType": "頭像要係 jpg、png 或 webp 格式。",
    "avatarTooLarge": "頭像檔案太大，上限 2MB。",
    "avatarError": "暫時上傳唔到頭像，請稍後重試。"
  },
  "zh-TW": {
    "title": "香城街坊福利會",
    "metaTitle": "香城街坊福利會 | 香城模擬器",
    "eyebrow": "NEIGHBOURHOOD ASSOCIATION",
    "intro": "註冊做街坊，先可以在【香城討論區】發文、留言、給予 emoji 回應，以及在【香城連儂牆】留言——註冊給你一個固定的街坊身份，日後福利會再加福利都是在這個身份上面加。",
    "joinTitle": "註冊 / 登入",
    "registerTab": "註冊",
    "loginTab": "登入",
    ...
    "avatarUploading": "正在上傳…",
    "avatarUploaded": "頭像已經更新。",
    "avatarInvalidType": "頭像須為 jpg、png 或 webp 格式。",
    "avatarTooLarge": "頭像檔案過大，上限 2MB。",
    "avatarError": "暫時無法上傳頭像，請稍後重試。"
  },
  "en": {
    "title": "Heung Shing Neighbourhood Association",
    "metaTitle": "Neighbourhood Association | The City of Heung Shing",
    "eyebrow": "NEIGHBOURHOOD ASSOCIATION",
    "intro": "Join the Association to post, comment or react in the Heung Shing Forum, and to post on the Heung Shing Lennon Wall — joining gives you a fixed neighbour identity that future Association perks will build on.",
    ...
    "avatarInvalidType": "The avatar must be jpg, png or webp.",
    "avatarTooLarge": "The avatar file is too large — 2MB max.",
    "avatarError": "Could not upload the avatar right now. Please try again later."
  },
  "ja": {
    "title": "香城街坊福利会",
    "metaTitle": "香城街坊福利会 | 香城模擬器",
    "eyebrow": "NEIGHBOURHOOD ASSOCIATION",
    "intro": "街坊会員に登録すると、【香城討論区】で投稿・コメント・絵文字リアクションができ、【香城レノンウォール】にも投稿できます——登録すると固定の街坊（隣人）アイデンティティが手に入り、今後の福利会の特典はこの上に追加されていきます。",
    "joinTitle": "登録 / ログイン",
    "registerTab": "登録",
    "loginTab": "ログイン",
    ...
    "avatarInvalidType": "アバターは jpg、png、webp のいずれかである必要があります。",
    "avatarTooLarge": "アバターのファイルサイズが大きすぎます（上限2MB）。",
    "avatarError": "現在アバターをアップロードできません。しばらくして再度お試しください。"
  }
};
